...
class SearchSuggester extends Component {
        ...
        return (
            <div className="SearchSuggester">
                ...
                <div className={`keywordBox ${errorClass}`}>
                    <input type="text" ref={(input) => { this.textInput = input }} onChange={() => this.callSuggetions(event)} value={this.state.currentKeywordInput} placeholder="Enter Locality..." />
                </div>
                {suggestionsList}
